...
const DateFilter = ({ showdateFilterElements }) => {
  ...
  return (
    <div className="DateFilter-parent">
      <div className="datefilter-child">
        {showdateFilterElements.datefilter && (
        ...
        {showdateFilterElements.accountReport && (
          <div className="select-part-parent-filter">
            <label className="label-part-date-filter">Account Statement</label>
        ...
        {showdateFilterElements.selectReport && (
          <div className="select-part-parent-filter">
            <label className="label-part-date-filter">Select Report</label>
        ...
        {showdateFilterElements.selectEvent && (
          <div className="select-part-parent-filter">
            <label className="label-part-date-filter">Select Report</label>
        ...
        {showdateFilterElements.selectMarketType && (
          <div className="select-part-parent-filter">
            <label className="label-part-date-filter">Select Report</label>
        ...
        {showdateFilterElements.selectMarket && (
          <div className="select-part-parent-filter">
            <label className="label-part-date-filter">Select Report</label>
